#pragma once
#include "bitbuf.hpp"
#include "inetmessagehandler.hpp"
...
#define svc_ClassInfo 10	 // Info about classes (first uint8_t is a CLASSINFO_ define).
...
enum
{
	...
	LOCALPLAYER,  // uint8_ts for local player entity update
	OTHERPLAYERS, // uint8_ts for other players update
	ENTITIES,     // all other entity uint8_ts
	SOUNDS,	      // game sounds
