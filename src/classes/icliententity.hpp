...
extern void DefaultRenderBoundsWorldspace(IClientRenderable *pRenderable, Vec3 &absMins, Vec3 &absMaxs);
...
class IClientRenderable
{
	...
	virtual void* /*ModelInstanceHandle_t*/ GetModelInstance() = 0;
