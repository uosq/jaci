...
public:
	...
	virtual void DrawTexturedPolyLine( const void *p,int n ) = 0; // (Note: this connects the first and last points).
	virtual void DrawTexturedSubRect( int x0, int y0, int x1, int y1, float texs0, float text0, float texs1, float text1 ) = 0;
	virtual void DrawTexturedPolygon(int n, void *pVertice, bool bClipVertices = true ) = 0;
	...
	virtual bool DrawGetUnicodeCharRenderInfo( wchar_t ch, void* info ) = 0;
	virtual void DrawRenderCharFromInfo( const void* info ) = 0;
